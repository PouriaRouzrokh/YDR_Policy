# Content from files-profile.medicine.yale.edu/documents/6e6c8a17-d066-48e2-b62f-1ccfd56feca5
...
| :--: | :--: | :--: |
| Albuterol MDI INHALER 90 mcg/actuation | 2 puffs ( $90 \mathrm{mcg} /$ puff) for a total of 180 mcg <br> -May repeat | 2 puffs ( $90 \mathrm{mcg} /$ puff) for a total of 180 mcg. <br> May repeat up to 3 times every 20 minutes |
...
| Diphenhydramine 25 mg ELIXIR/CAPSULE | $25-50 \mathrm{mg}$ PO | $1-2 \mathrm{mg} / \mathrm{kg}$ PO <br> -MAX single dose $=50 \mathrm{mg}$ |
| :--: | :--: | :--: |
| Epinephrine autoinjector (Epi-pen®) <br> ANAPHYLAXIS | Hives, diffuse erythema, bronchospasm, laryngeal edema, hypotension: <br> 0.3 mg IM <br> **Use 0.3 mg autoinjector** | Hives, diffuse erythema, bronchospasm, laryngeal edema, hypotension: <br> Weight $<30 \mathrm{~kg}: 0.15 \mathrm{mg}$ IM <br> (Use 0.15 mg auto-injector) <br> Weight $\geq 30 \mathrm{~kg}: 0.3 \mathrm{mg}$ IM <br> (Use 0.3 mg auto-injector) |
| Epinephrine $1 \mathrm{mg} / 10 \mathrm{~mL}$ PREFILLED SYRINGE for IV administration <br> (Anaphylaxis) <br> $(1 \mathrm{mg} / 10 \mathrm{ml})$ | Anaphylaxis (ONLY for very unstable patient: severe hypotension, tachycardia, severe airway edema) <br> 0.1 to 0.2 mg SLOW IV push ( $1-2 \mathrm{~mL}$ of $1 \mathrm{mg} / 10 \mathrm{ml}$ dilution) <br> May repeat every $5-15$ minutes as needed up to 1 mg total | Anaphylaxis: <br> $0.01 \mathrm{mg} / \mathrm{kg}$ IV ( $0.1 \mathrm{~mL} / \mathrm{kg}$ of $1 \mathrm{mg} /$ 10 ml dilution) <br> MAX individual dose: $\leq 30 \mathrm{~kg}=0.15 \mathrm{mg}(1.5 \mathrm{~mL})$ <br> $>30 \mathrm{~kg}=0.1$ to 0.3 mg ( 1 mL to 3 mL ) <br> -May repeat up to 1 mg total dose |
| Citirizine (Zyrtec) | 10 mg PO | 2-5 years: 5 mg PO <br> $\geq 6$ years: 10 mg PO |
...
| Sodium chloride $0.9 \% 500 \mathrm{~mL}$ | $1,000 \mathrm{~mL}$ rapidly IV | $10-20 \mathrm{~mL} / \mathrm{kg}$ rapidly IV <br> -MAX volume $=500 \mathrm{~mL}-1,000 \mathrm{~mL}$ |
